...
export default async function CardPage({
  ...
  return (
    <div className="mx-auto max-w-5xl px-6 pt-32 pb-20 md:px-8">
      <Link href={`/${locale}/deck`} className="font-mono text-[11px] uppercase tracking-[0.18em] text-[#9B8B6E] hover:text-[#161310]">
        ← {t.deck.back}
      </Link>
      ...
      <div className="mt-10 grid gap-16 md:grid-cols-2">
        ...
        <div className="space-y-10">
          <div>
            <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-black/35">{t.deck.meaning}</p>
            <p className="mt-4 text-[16px] leading-[1.8] text-black/70">{card.meaning}</p>
          </div>

          <div>
            <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-black/35">{t.deck.reflection}</p>
